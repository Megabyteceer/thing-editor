...
import TimelilneFieldControls from "thing-editor/src/editor/ui/props-editor/props-editors/timeline/timeline-field-controls";
...
import { TimelineFieldData, TimelineKeyFrame } from "thing-editor/src/engine/lib/assets/src/basic/movie-clip/field-player";
...
export default class FieldsTimelineView extends ComponentDebounced<FieldsTimelineViewProps> {
	...
	render() {
		...
		}, h(TimelilneFieldControls, { owner: this }), h(TimelineLineView, { owner: this })
		);
	}
}
